...
var getGames = function (req, res) {
    res.send(games_1.default);
};
exports.getGames = getGames;
var getGame = function (req, res) {
    var id = req.params.id;
    var game = games_1.default.find(function (game) { return game.id === id; });
    res.send(game);
};
...
var addGame = function (req, res) {
    ...
    allGames = __spreadArray(__spreadArray([], games_1.default, true), [game], false);
