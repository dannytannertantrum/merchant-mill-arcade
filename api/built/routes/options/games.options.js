...
var games_controller_ts_1 = require("../../controllers/games.controller.ts");
// Game schema
var Game = {
    type: 'object',
    properties: {
...
var getGamesOptions = {
    ...
    handler: games_controller_ts_1.getGames
};
...
var getGameOptions = {
    ...
    handler: games_controller_ts_1.getGame
};
...
var postGameOptions = {
    ...
    handler: games_controller_ts_1.addGame
};
...
var deleteGameOptions = {
    ...
    handler: games_controller_ts_1.deleteGame
};
...
var updateGameOptions = {
    ...
    handler: games_controller_ts_1.updateGame
};
